...
parser.add_argument('--test_model', type=str, default="./checkpoints/PICR_Net_epoch_120.pth")
#parser.add_argument('--test_model', type=str, default='./checkpoints/PICR_Net_epoch_100.pth')
